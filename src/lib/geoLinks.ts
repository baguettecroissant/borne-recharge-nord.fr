/**
 * Geographic proximity linking engine for the Nord (59).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (50.6°N for Nord)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(50.6°) ≈ 70.5 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 70.5;
